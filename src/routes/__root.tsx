...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A small corner of the internet by Yeswanth B — QA engineer at Cognizant, writer, and Ilayaraja enthusiast." },
      { property: "og:title", content: "Yeswanth B — QA Engineer & Writer" },
      { property: "og:description", content: "A small corner of the internet by Yeswanth B — QA engineer at Cognizant, writer, and Ilayaraja enthusiast." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Yeswanth B — QA Engineer & Writer" },
      { name: "twitter:description", content: "A small corner of the internet by Yeswanth B — QA engineer at Cognizant, writer, and Ilayaraja enthusiast." },
